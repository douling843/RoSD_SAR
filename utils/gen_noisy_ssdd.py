...
def preprocess_dataset(prefix='./data/ssdd/ssdd/'):   #####################
    print('\npreprocess COCO dataset ...')
    coco = SARDataset()                        ###########################################

    # load training data & save as pkl
    ann_file_train = prefix + 'annotations/train.json'   ###############################
    anno_train = coco.load_annotations(ann_file_train)
    save_path_train = prefix + 'ssdd2017_train.pkl'     #########################
...
if __name__ == '__main__':
    ...
    # save noisy anno 
    anno_prefix = './data/ssdd/ssdd/noisy_pkl/'     ###############################
