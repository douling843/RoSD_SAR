...
def preprocess_dataset(prefix='./data/hrsid/HRSID_JPG/'):   #####################
    print('\npreprocess COCO dataset ...')
    coco = SARDataset()                        ###########################################

    # load training data & save as pkl
    ann_file_train = prefix + 'annotations/train2017.json'   ###############################
    anno_train = coco.load_annotations(ann_file_train)
    save_path_train = prefix + 'hrsid2017_train.pkl'     #########################
...
if __name__ == '__main__':
    ...
    # preprocess coco dataset
    data_prefix = './data/hrsid/HRSID_JPG/'     #######################################
    ...
    # save noisy anno 
    anno_prefix = './data/hrsid/HRSID_JPG/noisy_pkl/'     ###############################
