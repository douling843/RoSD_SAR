...
train_cfg = dict(
    rpn=dict(
        assigner=dict( 
            type='MaxIoUAssigner',      #######################   'OTAHieAssigner'           'MaxIoUAssigner'
            pos_iou_thr=0.7,
            neg_iou_thr=0.3,
            min_pos_iou=0.3,
            match_low_quality=True,
            ignore_iof_thr=-1),
#             type='OTAHieAssigner', # Hierarchical Label Assigner (HLA)      OTAHieAssigner     HieAssigner  
#                 ignore_iof_thr=-1,
#                 gpu_assign_thr=512,
...
#                 ratio=0.9), # decay factor
    ...
    rcnn=dict(
        assigner=dict(
            ...
            min_pos_iou=0.5,               ##############################pos_iou_thr=0.5
